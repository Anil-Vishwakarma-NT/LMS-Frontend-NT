...
const enrollmentService = {
  ...
  async enroll(enrollmentData) {
    try {
      const response = await app.post('/api/enrollment/enroll', enrollmentData);
  ...
  async getEnrollmentStatistics() {
    try {
      const response = await app.get('/api/enrollment/statistics');
      return response.data;
    } catch (error) {
  ...
  async getAllGroups() {
    try {
      const response = await app.get('/group/Allgroups');
      return response.data;
    } catch (error) {
  ...
  async getUserEnrollmentsByUserId(userId) {
    try {
      const response = await app.get(`/api/enrollment/user-enrollments/${userId}`);
      return response.data;
    } catch (error) {
  ...
  async getAllUserEnrollments() {
    try {
      const response = await app.get('/api/enrollment/user-enrollments');
      return response.data;
    } catch (error) {
  ...
  async getUserCourseEnrollments() {
    try {
      const response = await app.get('/api/enrollment/user-course-enrollments');
      return response.data;
    } catch (error) {
  ...
  async getUserBundleEnrollments() {
    try {
      const response = await app.get('/api/enrollment/user-bundle-enrollments');
      return response.data;
    } catch (error) {
  ...
  async getEnrolledCoursesByUserId(userId) {
    try {
      const response = await app.get(`/api/enrollment/userCourses/${userId}`);
      return response.data;
    } catch (error) {
  ...
  async getAllCourses() {
    try {
      const response = await appCourse.get('/api/course');
      return response.data;
    } catch (error) {
  ...
  async getAllBundles() {
    try {
      const response = await appCourse.get('/api/bundles');
      return response.data;
    } catch (error) {
  ...
  async getCoursesByBundleId(bundleId) {
    try {
      const response = await appCourse.get(`/api/bundles/course-bundles/${bundleId}`);
      return response.data;
    } catch (error) {

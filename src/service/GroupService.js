...
export const getAllGroups = async () => {
    ...
    try {
        const response = await app.get('user/api/client-api/group/groups')
...
export const addGroup = async (group) => {
    try {
        const response = await app.post('user/api/client-api/group/create-group', group);
...
export const updateGroup = async (group) => {
    try {
        ...
        const response = await app.put("user/api/client-api/group/update-group", group);
...
export const deleteGroup = async (groupId) => {
    try {
        const response = await app.delete(`user/api/client-api/group/remove/${groupId}`);
    }
    catch (error) {
...
export const getUsersInGroup = async (groupId) => {
    try {
        const response = await app.get(`user/api/client-api/group/group-emps/${groupId}`)
...
export const deleteSingleUser = async (user) => {
    try {
        console.log(user);
        const response = await app.delete("user/api/client-api/group/remove-user", { data: user });
        return response.data;
